...
public class CHyS {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHyS dtohys) {
        ...
        if (shys.existsByNombre(dtohys.getNombre())) {
            return new ResponseEntity<>(new Mensaje("Es skill existe"), HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        ...
        shys.delete(id);
        return new ResponseEntity<>(new Mensaje("Skill elimanada"), HttpStatus.OK);
    }
